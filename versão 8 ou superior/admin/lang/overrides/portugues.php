...
$_ADMINLANG['urlCallback'] = "Url de Callback: <strong>";
$_ADMINLANG['notAccountMultibanco'] = "Não tem conta Multibanco";
$_ADMINLANG['notAccountMbway'] = "Não tem conta MB WAY";
$_ADMINLANG['notAccountPayshop'] = "Não tem conta Payshop";
$_ADMINLANG['notAccountCcard'] = "Não tem conta Cartão de Crédito";
$_ADMINLANG['requestAccountMultibanco'] = "Solicite a criação de conta Multibanco";
$_ADMINLANG['requestAccountMbway'] = "Solicite a criação de conta MB WAY";
$_ADMINLANG['requestAccountPayshop'] = "Solicite a criação de conta Payshop";
$_ADMINLANG['requestAccountCcard'] = "Solicite a criação de conta Cartão de Crédito";
$_ADMINLANG['sendEmailNewAccount'] = "Enviar Email";
$_ADMINLANG['updateAccountDescription'] = "Após receber os dados da nova conta, atualize os seus dados abaixo:";
$_ADMINLANG['updateAccount'] = "Actualizar Conta";
$_ADMINLANG['backofficeKey'] = "Chave de Acesso ao Backoffice";
$_ADMINLANG['backofficeKeyDescription'] = "Insira a chave de acesso ao backofficem, fornecida pela Ifthenpay";
$_ADMINLANG['cancelMbwayOrder'] = "Cancelar Encomenda MB WAY";
$_ADMINLANG['cancelMbwayOrderDescription'] = "Selecione para cancelar automaticamente os pedidos MB WAY se a notificação tiver expirado.";
$_ADMINLANG['cancelMultibancoOrder'] = "Cancelar Encomenda Multibanco";
$_ADMINLANG['cancelMultibancoOrderDescription'] = "Selecione para cancelar automaticamente as encomendas por multibanco se a referência tiver expirado.";
$_ADMINLANG['cancelCCardOrder'] = "Cancelar Encomenda Cartão de Crédito";
...
$_ADMINLANG['backofficeKeyInvalid'] = 'Chave de acesso ao backoffice é inválida';
$_ADMINLANG['ifthenpayNewUpdateTitle'] = "Nova Atualização disponível!";
$_ADMINLANG['ifthenpayNoUpdate'] = "O Módulo está Atualizado!";
$_ADMINLANG['downloadUpdateIfthenpay'] = "Download Atualização";
$_ADMINLANG['creditCardInvalidMethod'] = 'Não é possível gerar pagamento por Cartão de Crédito no backoffice.';
