...
//ifthenpay lang
$_LANG['mbwayPhoneRequired'] = "MB WAY Phone is Required";
$_LANG['mbwayPhoneInvalid'] = "MB WAY Phone is Invalid";
$_LANG['errorCallbackActivation'] = "Error Activating Callback";
$_LANG['errorCallbackPaymentNotFound'] = "Payment not found";
$_LANG['errorCallbackProcessing'] = "Error processing callback - ";
$_LANG['invalidSecurityToken'] = "Invalid Security token";
$_LANG['errorPaymentTotal'] = "Payment total does not correspond to the order value.";
$_LANG['paymentSuccessful'] = "Success: successful payment";
$_LANG['paymentErrorProcessing'] = "Error processing payment";
$_LANG['paymentOrderNotFound'] = "Order not found.";
$_LANG['orderPaid'] = "Order has already been paid.";
$_LANG['antiPhishingKeyNotSentCallback'] = "Anti-Phishing Key not sent.";
$_LANG['antiPhishingKeyNotValidCallback'] = "Anti-Phishing is not valid.";
$_LANG['backofficeKeyInvalid'] = 'Backoffice key is invalid';
$_LANG['mbwayUnderPayment'] = "Mbway does not allow payments under 0.10€";
$_LANG['invalidMultibancoValue'] = "Invalid Multibanco value, above 999999€";
$_LANG['invalidPayshopValue'] = "Payshop does not allow payments of 0€";
$_LANG['mbwayExpiredCanceled'] = "Canceled: MB WAY notification has expired";
$_LANG['mbwaySendNotificationSuccess'] = "MB WAY notification sent with success. Confirm payment on your MB WAY app.";
$_LANG['mbwaySendNotificationError'] = "Error sending MB WAY notification.";
$_LANG['errorPaymentProcessing'] = "Something went wrong!";
$_LANG['errorPaymentProcessingDescription'] = "There was an error processing your request, please contact our customer support team";
$_LANG['entityMultibanco'] = "Entity:";
$_LANG['ifthenpayReference'] = "Reference:";
$_LANG['ifthenpayTotalToPay'] = "Total to pay:";
$_LANG['phoneMbway'] = "Phone:";
$_LANG['notReceiveMbwayNotification'] = "Not receive MBway notification?";
$_LANG['resendMbwayNotification'] = "Resend MBway notification";
$_LANG['payshopDeadline'] = "Deadline:";
$_LANG['paymentReturnTitle'] = "Please use the data below to pay for your order.";
$_LANG['confirmMbwayPaymentTitle'] = "Confirm payment in your MB WAY App";
$_LANG['mbwayExpireTitle'] = "If you do not confirm payment in 5 minutes, the payment notification will expire.";
