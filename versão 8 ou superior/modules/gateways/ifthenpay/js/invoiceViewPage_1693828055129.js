...
/******/
{
  ...
  function _devJsClassesMbwayCountDownTs(module, exports, __webpack_require__) {
    ...
    var MbwayUtility_1 = __webpack_require__(
    /*! ../utility/MbwayUtility */
    "./_dev/js/utility/MbwayUtility.ts");

    var MbwayCountdown =
    /** @class */
    function () {
      function MbwayCountdown(httpService, mbwayUtility) {
        this.timer2 = '5:01';
      ...
      MbwayCountdown.prototype.checkMBwayPaymentStatus = function () {
        ...
        window.mbwayInterval2 = setInterval(function () {
          _this.httpService.setUrl(ifthenpayData.cancelMbwayOrderUrl);

          _this.httpService.get().then(function (response) {
            if (response.orderStatus === 'paid') {
              var resendMbwayNotificationMbway = $('#resendMbwayNotificationMbway');
            ...
            _this.mbwayUtility.deleteAllMessages();
          }).fail(function (xhr, status, error) {
            console.log(error);

            _this.countdownPanel.hide();

            $(_this.mbwayUtility.getErrorMessage(error.error)).insertBefore(_this.countdownPanel);
          });
        }, 10000);
      };
      ...
      MbwayCountdown.prototype.mbwayOrderCancel = function () {
        ...
        this.httpService.get().then(function (response) {
      ...
      MbwayCountdown = __decorate([inversify_1.injectable(), __metadata("design:paramtypes", [HttpService_1.HttpService, MbwayUtility_1.MbwayUtility])], MbwayCountdown);
  ...
  /***/
  "./_dev/js/container/inversify.invoiceViewPage.ts":
  /*!********************************************************!*\
    !*** ./_dev/js/container/inversify.invoiceViewPage.ts ***!
    \********************************************************/
  ...
  /***/
  function _devJsContainerInversifyInvoiceViewPageTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var InvoiceViewPage_1 = __webpack_require__(
    /*! ../events/InvoiceViewPage */
    "./_dev/js/events/InvoiceViewPage.ts");

    var InvoiceViewPageCreateApp_1 = __webpack_require__(
    /*! ../facades/InvoiceViewPageCreateApp */
    "./_dev/js/facades/InvoiceViewPageCreateApp.ts");
    ...
    var containerInvoiceViewPage = new inversify_1.Container();
    containerInvoiceViewPage.bind(MbwayUtility_1.MbwayUtility).toDynamicValue(function (context) {
      return new MbwayUtility_1.MbwayUtility(ifthenpayData.lang.mbwayPhoneRequired, ifthenpayData.lang.mbwayPhoneInvalid);
    });
    containerInvoiceViewPage.bind(HttpService_1.HttpService).toSelf();
    containerInvoiceViewPage.bind(MbwayCountDown_1.MbwayCountdown).toSelf();
    containerInvoiceViewPage.bind(InvoiceViewPage_1.InvoiceViewPage).toSelf();
    containerInvoiceViewPage.bind(InvoiceViewPageCreateApp_1.InvoiceViewPageCreateApp).toSelf();
    exports["default"] = containerInvoiceViewPage;
    /***/
  },
  ...
  function _devJsDecoratorsEventTs(module, exports, __webpack_require__) {
    ...
    exports.Event = function (type, selector, dynamic) {
  ...
  /***/
  function _devJsEventsInvoiceViewPageTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.InvoiceViewPage = void 0;
    ...
    var inversify_invoiceViewPage_1 = __webpack_require__(
    /*! ../container/inversify.invoiceViewPage */
    "./_dev/js/container/inversify.invoiceViewPage.ts");
    ...
    /** @class */
    function (_super) {
      __extends(InvoiceViewPage, _super);

      function InvoiceViewPage(mbwayUtility) {
        var _this = _super.call(this) || this;

        _this.mbwayUtility = mbwayUtility;
        return _this;
      }

      InvoiceViewPage.prototype.submitMbwayPayment = function (event) {
        this.setEventDefault(event, false);
        return this.mbwayUtility.checkMbwayBeforeSubmit(this.eventTarget);
      };

      InvoiceViewPage.prototype.resendMbwayNotification = function (event) {
        var _this = this;
        ...
        this.httpService = inversify_invoiceViewPage_1["default"].get(HttpService_1.HttpService);
        this.httpService.setUrl(this.eventTarget.attr('href'));
        this.httpService.get().then(function (response) {
          _this.mbwayCountdownPanel.show();

          inversify_invoiceViewPage_1["default"].get(MbwayCountDown_1.MbwayCountdown).init();
          $(_this.mbwayUtility.getSuccessMessage(response.success)).insertBefore(_this.mbwayCountdownPanel);

          _this.spinner.hide();
        }).fail(function (xhr, status, error) {
          $(_this.htmlUtility.getErrorMessage(xhr.responseJSON.error)).insertBefore(_this.eventTarget);

          _this.spinner.remove();
        });
      };

      __decorate([Event_1.Event('submit', '#formIfthenpayMbway'), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", Boolean)], InvoiceViewPage.prototype, "submitMbwayPayment", null);

      __decorate([Event_1.Event('click', '#resendMbwayNotificationMbway'), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], InvoiceViewPage.prototype, "resendMbwayNotification", null);

      InvoiceViewPage = __decorate([inversify_1.injectable(), __metadata("design:paramtypes", [MbwayUtility_1.MbwayUtility])], InvoiceViewPage);
      return InvoiceViewPage;
    }(Page_1.Page);

    exports.InvoiceViewPage = InvoiceViewPage;
    /***/
  },
  ...
  /***/
  function _devJsFacadesInvoiceViewPageCreateAppTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.InvoiceViewPageCreateApp = void 0;
    ...
    var InvoiceViewPageCreateApp =
    /** @class */
    function (_super) {
      __extends(InvoiceViewPageCreateApp, _super);

      function InvoiceViewPageCreateApp() {
        var _this = _super.call(this) || this;

        _this.container = inversify_invoiceViewPage_1["default"];
        return _this;
      }

      InvoiceViewPageCreateApp.prototype.start = function () {};

      InvoiceViewPageCreateApp = __decorate([inversify_1.injectable(), AppComponent_1.AppComponent({
        pageEvents: [InvoiceViewPage_1.InvoiceViewPage],
        apps: [MbwayCountDown_1.MbwayCountdown]
      }), __metadata("design:paramtypes", [])], InvoiceViewPageCreateApp);
      return InvoiceViewPageCreateApp;
    }(MainApp_1.MainApp);

    exports.InvoiceViewPageCreateApp = InvoiceViewPageCreateApp;
    /***/
  },
  ...
  /***/
  function _devJsInvoiceViewPageTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    $(document).ready(function () {
      var app = inversify_invoiceViewPage_1["default"].get(InvoiceViewPageCreateApp_1.InvoiceViewPageCreateApp);
      app.start();
    });
    /***/
  },
  ...
  /***/
  "./_dev/js/utility/HtmlUtility.ts":
  /*!****************************************!*\
    !*** ./_dev/js/utility/HtmlUtility.ts ***!
    \****************************************/
  ...
  /***/
  function _devJsUtilityHtmlUtilityTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      HtmlUtility.prototype.checkMessage = function (messageId) {
      ...
      HtmlUtility.prototype.deleteAllMessages = function () {
        var messageSuccess = $('#ifthenpaySuccessMessage');
        var messageError = $('#ifthenpayErrorMessage');
      ...
      HtmlUtility.prototype.getErrorMessage = function (errorMessage) {
        this.checkMessage('#ifthenpayErrorMessage');
        return "<div id=\"ifthenpayErrorMessage\" class=\"alert alert-danger\">" + errorMessage + "</div>";
      };

      HtmlUtility.prototype.getSuccessMessage = function (successMessage) {
      ...
      HtmlUtility.prototype.getSpinnerHtml = function (systemUrl) {
        return "<div class=\"appSpinner\" style=\"display:none\">\n            <img src=\"" + (systemUrl + 'modules/gateways/ifthenpay/svg/oval.svg') + "\"/>\n        </div>";
      };

      HtmlUtility = __decorate([inversify_1.injectable()], HtmlUtility);
      return HtmlUtility;
    }();
  ...
  /***/
  function _devJsUtilityMbwayUtilityTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.MbwayUtility = void 0;

    var inversify_1 = __webpack_require__(
    /*! inversify */
    "./node_modules/inversify/lib/inversify.js");

    var HtmlUtility_1 = __webpack_require__(
    /*! ./HtmlUtility */
    "./_dev/js/utility/HtmlUtility.ts");
    ...
    /** @class */
    function (_super) {
      __extends(MbwayUtility, _super);

      function MbwayUtility(mbwayPhoneErrorRequiredMessage, mbwayPhoneErrorInvalidMessage) {
        var _this = _super.call(this) || this;

        _this.MBWAY_PHONE_REGEX = /^((91|96|92|93)[0-9]{7})$/g;
        _this.mbwayPhoneErrorRequiredMessage = mbwayPhoneErrorRequiredMessage;
        _this.mbwayPhoneErrorInvalidMessage = mbwayPhoneErrorInvalidMessage;
        return _this;
      }

      Object.defineProperty(MbwayUtility.prototype, "mbwayPhoneRegex", {
        get: function get() {
      ...
      Object.defineProperty(MbwayUtility.prototype, "mbwayPhoneErrorRequired", {
        get: function get() {
      ...
      Object.defineProperty(MbwayUtility.prototype, "mbwayPhoneErrorInvalid", {
        get: function get() {
      ...
      MbwayUtility.prototype.checkMbwayBeforeSubmit = function (eventTarget, mbwayCountdownShow) {
        if (mbwayCountdownShow === void 0) {
          mbwayCountdownShow = 'true';
        }

        var mbwayPhoneNumber = $('#phone_number').val();
      ...
      MbwayUtility.prototype.getMbwayPhoneHtml = function (systemUrl, submitBtn) {
        if (submitBtn === void 0) {
          submitBtn = false;
        }
      ...
      MbwayUtility.prototype.removeMbwayPhoneHtml = function () {
        $('#ifthenpayMbwayPhoneDiv').remove();
      };

      MbwayUtility = __decorate([inversify_1.injectable(), __metadata("design:paramtypes", [String, String])], MbwayUtility);
      return MbwayUtility;
    }(HtmlUtility_1.HtmlUtility);

    exports.MbwayUtility = MbwayUtility;
    /***/
  },
  ...
  1:
  /*!******************************************!*\
    !*** multi ./_dev/js/invoiceViewPage.ts ***!
    \******************************************/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/devilbox/data/www/whmcs/htdocs/_dev/frontend/_dev/js/invoiceViewPage.ts */
    "./_dev/js/invoiceViewPage.ts");
    /***/
  }
  /******/
