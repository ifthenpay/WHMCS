...
/******/
{
  ...
  /***/
  "./_dev/js/classes/AdminConfig.ts":
  /*!****************************************!*\
    !*** ./_dev/js/classes/AdminConfig.ts ***!
    \****************************************/
  ...
  /***/
  function _devJsClassesAdminConfigTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      AdminConfig.prototype.reloadIfSaveSuccessfull = function (buttonElement) {
        var iterations = 15; // Total number of iterations for 3 seconds
      ...
      AdminConfig.prototype.bindOnClick = function (buttonElement) {
        var _this = this;

        if (buttonElement.length > 0) {
          buttonElement.on('click', function () {
            _this.reloadIfSaveSuccessfull(buttonElement);
          });
        }
      };

      AdminConfig.prototype.toggleDeadlineDropdownVisibility = function (entitySelect, deadlineSelect) {
      ...
      AdminConfig.prototype.setOnChangeDeadlineDropdownToggle = function () {
        var _this = this;

        var entitySelect = $("#configmultibancoForm").find("select[name='field[entidade]']");
        var deadlineSelect = $("#configmultibancoForm").find("select[name='field[multibancoValidity]']");

        if (entitySelect.length > 0 && deadlineSelect.length > 0) {
          entitySelect.on('change', function () {
            _this.toggleDeadlineDropdownVisibility(entitySelect, deadlineSelect);
          });
          this.toggleDeadlineDropdownVisibility(entitySelect, deadlineSelect); // on load
        }
      };

      AdminConfig.prototype.hideCcardCallbackFormFields = function () {
        var configForm = $("#configccardForm");
        var activateCallbackSwitch = configForm.find("input[name='field[activateCallback]']");
        var sandboxSwitch = configForm.find("input[name='field[sandboxMode]']");
        var callbackInfo = configForm.find(".ifthenpay_callback_badge");
      ...
      AdminConfig.prototype.init = function () {
        ...
        var buttonElementCcard = $("#configccardForm").find("button[type='submit'].btn.btn-primary");
        var buttonElementMbway = $("#configmbwayForm").find("button[type='submit'].btn.btn-primary");
        var buttonElementMultibanco = $("#configmultibancoForm").find("button[type='submit'].btn.btn-primary");
        var buttonElementPayshop = $("#configpayshopForm").find("button[type='submit'].btn.btn-primary");
      ...
      AdminConfig = __decorate([inversify_1.injectable()], AdminConfig);
      return AdminConfig;
    }();
  ...
  function _devJsContainerInversifyAdminConfigPageTs(module, exports, __webpack_require__) {
    ...
    var AdminConfig_1 = __webpack_require__(
    /*! ../classes/AdminConfig */
    "./_dev/js/classes/AdminConfig.ts");

    var containerAdminConfigPage = new inversify_1.Container();
    containerAdminConfigPage.bind(HtmlUtility_1.HtmlUtility).toSelf();
    ...
    containerAdminConfigPage.bind(AdminConfig_1.AdminConfig).toSelf();
  ...
  function _devJsEventsAdminConfigPageTs(module, exports, __webpack_require__) {
    ...
    function (_super) {
      ...
      function AdminConfigPage(htmlUtility) {
        var _this = _super.call(this) || this;

        _this.htmlUtility = htmlUtility;
        return _this;
      }
      ...
      AdminConfigPage.prototype.changeEntidade = function (event) {
        ...
        var containerSubEntidade = $('select[name ="field[subEntidade]"]');
        this.spinner.show();
      ...
      AdminConfigPage.prototype.addNewAccount = function (event) {
        var _this = this;
        ...
        this.httpService.post({
          ...
          $(_this.htmlUtility.getSuccessMessage(response.success)).insertBefore(_this.eventTarget);
      ...
      AdminConfigPage.prototype.addMultibancoDynamicAccount = function (event) {
        var _this = this;
      ...
      __decorate([Event_1.Event('change', 'select[name ="field[entidade]"]'), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], AdminConfigPage.prototype, "changeEntidade", null);

      __decorate([Event_1.Event('click', '#requestNewAccount'), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], AdminConfigPage.prototype, "addNewAccount", null);

      __decorate([Event_1.Event('click', '#requestMultibancoDynamicAccount'), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], AdminConfigPage.prototype, "addMultibancoDynamicAccount", null);

      AdminConfigPage = __decorate([inversify_1.injectable(), __metadata("design:paramtypes", [HtmlUtility_1.HtmlUtility])], AdminConfigPage);
  ...
  function _devJsFacadesAdminConfigPageCreateAppTs(module, exports, __webpack_require__) {
    ...
    function (_super) {
      ...
      AdminConfigPageCreateApp = __decorate([inversify_1.injectable(), AppComponent_1.AppComponent({
        ...
        apps: [AdminConfig_1.AdminConfig]
  ...
  /***/
  "./_dev/scss/checkoutPaymentOption.scss":
  /*!**********************************************!*\
    !*** ./_dev/scss/checkoutPaymentOption.scss ***!
    \**********************************************/
  ...
  /***/
  function _devScssCheckoutPaymentOptionScss(module, exports) {// removed by extract-text-webpack-plugin
  ...
  /***/
  "./_dev/scss/ifthenpayViewInvoice.scss":
  /*!*********************************************!*\
    !*** ./_dev/scss/ifthenpayViewInvoice.scss ***!
    \*********************************************/
  ...
  /***/
  function _devScssIfthenpayViewInvoiceScss(module, exports) {// removed by extract-text-webpack-plugin

    /***/
  },

  /***/
  "./_dev/scss/mbwayPhoneInput.scss":
  /*!****************************************!*\
    !*** ./_dev/scss/mbwayPhoneInput.scss ***!
    \****************************************/
  ...
  /***/
  function _devScssMbwayPhoneInputScss(module, exports) {// removed by extract-text-webpack-plugin
  ...
  0:
  /*!*******************************************************************************************************************************************************************************************************************************************!*\
    !*** multi ./_dev/js/adminConfigPage.ts ./_dev/scss/ifthenpayPaymentMethodSetup.scss ./_dev/scss/mbwayPhoneInput.scss ./_dev/scss/ifthenpayConfirmPage.scss ./_dev/scss/checkoutPaymentOption.scss ./_dev/scss/ifthenpayViewInvoice.scss ***!
    \*******************************************************************************************************************************************************************************************************************************************/
  ...
  function _(module, exports, __webpack_require__) {
    __webpack_require__(
    /*! /home/devilbox/data/www/whmcs/htdocs/_dev/frontend/_dev/js/adminConfigPage.ts */
    "./_dev/js/adminConfigPage.ts");

    __webpack_require__(
    /*! /home/devilbox/data/www/whmcs/htdocs/_dev/frontend/_dev/scss/ifthenpayPaymentMethodSetup.scss */
    "./_dev/scss/ifthenpayPaymentMethodSetup.scss");

    __webpack_require__(
    /*! /home/devilbox/data/www/whmcs/htdocs/_dev/frontend/_dev/scss/mbwayPhoneInput.scss */
    "./_dev/scss/mbwayPhoneInput.scss");

    __webpack_require__(
    /*! /home/devilbox/data/www/whmcs/htdocs/_dev/frontend/_dev/scss/ifthenpayConfirmPage.scss */
    "./_dev/scss/ifthenpayConfirmPage.scss");

    __webpack_require__(
    /*! /home/devilbox/data/www/whmcs/htdocs/_dev/frontend/_dev/scss/checkoutPaymentOption.scss */
    "./_dev/scss/checkoutPaymentOption.scss");

    module.exports = __webpack_require__(
    /*! /home/devilbox/data/www/whmcs/htdocs/_dev/frontend/_dev/scss/ifthenpayViewInvoice.scss */
    "./_dev/scss/ifthenpayViewInvoice.scss");
    /***/
  }
  /******/
