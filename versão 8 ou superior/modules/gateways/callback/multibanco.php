...
$ioc->makeWith(Router::class, [
    ...
    if (empty($paymentData)) {
        ...
        try {
            ...
            $transid = $paymentData['entidade'] . $paymentData['referencia'] . $paymentData['order_id'];
            $amount = $_GET['valor'];
            ...
            $utility->saveIfthenpayPayment('ifthenpay_multibanco', $paymentData['id']);
